...
private:
    static HINSTANCE mHInstance; //hInstance windows 
    static HWND mHwnd; // hwnd 
    static LPD3DXSPRITE mSpriteHandler; //spriteHanlder 
    static int mWidth, mHeight; //size window
    static LPDIRECT3DDEVICE9 mDevice; //device directX 
};
